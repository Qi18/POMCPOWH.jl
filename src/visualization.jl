function D3Trees.D3Tree(p::POMCPOWHHPlanner; title="POMCPOWH Tree", kwargs...)
    @warn("""
...
function D3Trees.D3Tree(t::POMCPOWHTree; title="POMCPOWH Tree", kwargs...)
...
Base.show(io::IO, mime::MIME"text/html", t::POMCPOWHTree) = show(io, mime, D3Tree(t))
Base.show(io::IO, mime::MIME"text/plain", t::POMCPOWHTree) = show(io, mime, D3Tree(t))
